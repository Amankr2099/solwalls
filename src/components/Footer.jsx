  ...
  return (
    <footer className="bg-gray-800 text-white py-10 max-w-screen mt-10">
      <div className="text-center mb-6">
        ...
        <Link href={'/about'}>
        <p className='px-2 hover:text-gray-400'>About Us</p>
        </Link>

        <Link href={'/contact'}>
        <p className='px-2 hover:text-gray-400'>Contact Us</p>
        </Link>

        <Link href={'/policy'}>
        <p className='px-2 hover:text-gray-400'>Privacy Policy</p>
        </Link>

        <Link href={'/terms'}>
        <p className='px-2 hover:text-gray-400'>Terms and Conditions</p>
        </Link>
        </div>
        ...
        <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="mx-3 text-xl hover:text-red-600">
